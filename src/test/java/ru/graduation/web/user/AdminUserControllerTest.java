...
class AdminUserControllerTest extends AbstractControllerTest {
    ...
    private static final String API_URL = AdminUserController.REST_URL + '/';
    ...
    void get() throws Exception {
        perform(MockMvcRequestBuilders.get(API_URL + ADMIN_ID))
    ...
    void delete() throws Exception {
        perform(MockMvcRequestBuilders.delete(API_URL + USER_ID))
                .andDo(print())
    ...
    void enableNotFound() throws Exception {
        perform(MockMvcRequestBuilders.patch(API_URL + NOT_FOUND)
                .param("enabled", "false")
    ...
    void update() throws Exception {
        ...
        updated.setId(null);
        perform(MockMvcRequestBuilders.put(API_URL + USER_ID)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void enable() throws Exception {
        perform(MockMvcRequestBuilders.patch(API_URL + USER_ID)
                .param("enabled", "false")
                .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(status().isNoContent());
