...
public class MealTestData {
    ...
    public static final Dish DISH_1 = new Dish(MEAL_ID1, 500, "Завтрак");
    public static final Dish DISH_2 = new Dish(MEAL_ID2, 600, "Обед");
    public static final Dish DISH_6 = new Dish(MEAL_ID6, 400, "Ужин");

    public static Dish getNew() {
        return new Dish(null, 1500, "Ланч");
    }

    public static Dish getUpdated() {
        return new Dish(MEAL_ID1, 2000, "Бизнес ланч");
    }
}
